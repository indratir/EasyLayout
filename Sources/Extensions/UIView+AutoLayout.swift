...
public extension UIView {
    ...
    func alignWithSuperview(
        ...
        if let superview = self.superview {
            for side in sides {
                constraints.append(align(side, withSide: side, of: superview, distance: distance, priority: priority))
            }
        }
    ...
    func alignWithSuperview(
        ...
        if let constraint = alignWithSuperview(sides: [side], distance: distance, priority: priority).first {
            return constraint
        }
    ...
    func alignWithSafeArea(
        ...
        if let constraint = alignWithSafeArea(sides: [side], distance: distance, priority: priority).first {
            return constraint
        }
